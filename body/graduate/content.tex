...
在实际应用时，仍然需要考虑到用户可能会不接受部分广告的情况。在考虑到广告之间正向关系的序列广告推荐的中，由于序列中的广告和广告之间的关系有额外收益，一个广告被移除带来的影响可能不仅局限于这个广告本身，而是影响到所有与其相连的广告而进一步对整个序列的价值造成巨大影响。因此还需要考虑到广告序列的鲁棒性。
