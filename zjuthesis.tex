...
\documentclass[
    ...
    % Thesis Info
    ClassNumber     = TP301.6,          % 按中国图书分类法，学位办网上可查
    ...
    % Title
    Title           = 多轮社交广告序列影响最大化推荐算法,
    TitleEng        = {{Multi-Round Social Advertising Sequence Influence Maximization Recommendation Algorithm}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
%\titletwolines{多轮社交广告序列}{影响最大化推荐算法}
%  \titleengtwolines{Mulrtising Sequence}{Influence}
% \titlethreelines{毕业论文题目第一行}{毕业论文题目第二行}{毕业论文题目第三行}
\titleengtwolines{Multi-Round Social Advertising Sequence Influ-}{ence Maximization Recommendation Algorithm}
